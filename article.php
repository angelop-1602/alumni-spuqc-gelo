    ...
    <div class="row-items">
        <div class="col-lg-12">
            <div class="row">
                ...
                $ci = 0;
                $img = array();
                $fpath = 'admin/assets/uploads/article';
                ...
                $gallery = $conn->query("SELECT * from articles order by id desc");
                while ($row = $gallery->fetch_assoc()):
                    ...
                    ?>
                    <div class="col-md-6">
                        <div class=" d-flex flex-column card gallery-list border border-secondary  <?php echo $rtl ?>"
                            ...
                            <div class="card-body text-center w-auto">
                                <span class="fs-3 text-uppercase"><?php echo ucwords($row['title']) ?></span>
                            </div>
                        </div>
                        <br>
                    </div>
